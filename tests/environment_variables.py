#!/usr/bin/env python3
"""Tests for the Windows environment variables collector."""
...
class WindowsEnvironmentVariablesCollectorTest(shared_test_lib.BaseTestCase):
    """Tests for the Windows environment variables collector."""
    ...
    def testCollect(self):
        ...
        collector_object = environment_variables.WindowsEnvironmentVariablesCollector()
