...
def Main():
    ...
    try:
        ...
        for file_entry, path_segments in entry_lister.ListFileEntries(base_path_specs):
            ...
            for data_stream in file_entry.data_streams:
                ...
                if (
                    data_stream.name == "WofCompressedData"
                    and file_entry.type_indicator
                ...
                for extent in data_stream.GetExtents():
                    if extent.extent_type != dfvfs_definitions.EXTENT_TYPE_SPARSE:
                        ...
                        print(
                            f"0x{extent.offset:08x}\t0x{extent_end_offset:08x}\t"
